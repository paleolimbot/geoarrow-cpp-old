...
class PointArrayBuilder : public ComputeBuilder {
 public:
  ...
  const char* get_format() { return builder_->get_format(); }
 ...
 private:
  using Float64ListBuilder = arrow::hpp::builder::FixedSizeListArrayBuilder<
      arrow::hpp::builder::Float64ArrayBuilder>;
  bool null_is_empty_;
